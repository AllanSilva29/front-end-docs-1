...
Lembre-se do [processo de reconciliação](/front-end-docs-1/2-fundamentos-react/5-o-virtual-dom/): o React compara a árvore do Virtual DOM antiga com a nova para descobrir o que mudou. Quando se trata de listas, as `keys` dão ao React uma maneira de identificar os itens de forma inteligente, em vez de depender apenas de sua ordem.
